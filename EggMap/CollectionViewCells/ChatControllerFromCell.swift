...
class ChatControllerFromCell: BaseCell {
    ...
    override func setupViews() {
        ...
        bubbleView.anchor(topAnchor, left: nil, bottom: bottomAnchor, right: rightAnchor, topConstant: 0, leftConstant: 0, bottomConstant: 0, rightConstant: 10, widthConstant: ScreenSize.width * 0.8, heightConstant: 0)
