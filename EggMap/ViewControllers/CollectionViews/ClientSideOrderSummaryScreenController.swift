...
class ClientSideOrderSummaryScreenController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.orderSummaryCollectionView.register(ClientSideOrderSummaryCell.self, forCellWithReuseIdentifier: cellId)
        setupViews()
    }
...
extension ClientSideOrderSummaryScreenController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = orderSummaryCollectionView.dequeueReusableCell(withReuseIdentifier: cellId, for: indexPath) as! ClientSideOrderSummaryCell
...
extension ClientSideOrderSummaryScreenController: SideBarViewDelegate {
