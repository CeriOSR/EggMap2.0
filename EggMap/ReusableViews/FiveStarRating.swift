...
//  EggMap
//
//  Created by Rey Cerio on 2018-09-30.
...
class FiveStarRating: UIStackView {
    ...
    private func setupButtons() {
        ...
        //building 5 buttons and adding them to stackView
        for index in 0..<starCount {
            ...
            //this is if you want to press a star to choose rating. currently we are doing long swipe gesture
